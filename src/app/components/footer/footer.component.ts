          ...
          <div class="grid grid-cols-1 gap-10 lg:grid-cols-[1.15fr_0.7fr_0.7fr_0.9fr]">
            ...
            <div>
              ...
              <ul class="space-y-3">
                ...
                <li><a routerLink="/contact" class="sr-link">Fan Zone</a></li>
              </ul>
            </div>

            <div>
              <h4 class="sr-meta mb-4">Legal</h4>
              <ul class="space-y-3">
                <li><a href="#" class="sr-link">Privacy Policy</a></li>
                <li><a href="#" class="sr-link">Terms of Use</a></li>
                <li><a href="#" class="sr-link">Copyright Notice</a></li>
                <li><a href="#" class="sr-link">Cookie Policy</a></li>
              </ul>
            </div>

            <div>
              <h4 class="sr-meta mb-4">Stay Updated</h4>
              <p class="sr-card-text mb-4">Subscribe to receive updates about Samantha's latest projects and events.</p>
              <form class="space-y-3">
                <input 
                  ...
                  class="sr-input" 
                />
                <button type="submit" class="sr-button w-full">
                  Subscribe
                </button>
              </form>
            </div>
