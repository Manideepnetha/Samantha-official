...
export class FilmographyComponent implements OnInit {
  movies: Movie[] = [
    ...
    { id: 20, title: 'S/O Satyamurthy', year: 2015, language: 'Telugu', genre: ['Drama'], role: 'Subbalakshmi', director: 'Trivikram Srinivas', poster: 'https://res.cloudinary.com/dpnd6ve1e/image/upload/v1748122620/SAVE_20210802_162749_wimbn1.jpg', description: 'Released April 9, 2015.', trailer: '' },
