          ...
          <div class="p-6 space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
               ...
               <!-- Poster URL -->
               <div class="md:col-span-2">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Poster URL</label>
                <input [(ngModel)]="currentMovie.poster" type="text" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-deep-black text-gray-900 dark:text-ivory focus:ring-royal-gold focus:border-royal-gold">
              </div>
