...
export class FilmographyComponent implements OnInit {
  movies: Movie[] = [
    { id: 1, title: 'Ye Maaya Chesave', year: 2010, releaseDate: '2010-02-26', language: 'Telugu', genre: ['Romance', 'Drama'], role: 'Jessie', director: 'Gautham Vasudev Menon', poster: '', description: 'Released February 26, 2010.', trailer: '' },
    ...
    { id: 3, title: 'Baana Kaathadi', year: 2010, releaseDate: '2010-08-06', language: 'Tamil', genre: ['Drama'], role: 'Priya', director: 'Badri Venkatesh', poster: '', description: 'Released August 6, 2010.', trailer: '' },
    { id: 4, title: 'Moscowin Kavery', year: 2010, releaseDate: '2010-08-27', language: 'Tamil', genre: ['Romance'], role: 'Kaveri', director: 'Ravi Varman', poster: '', description: 'Released August 27, 2010.', trailer: '' },
    { id: 5, title: 'Brindavanam', year: 2010, releaseDate: '2010-10-14', language: 'Telugu', genre: ['Romance', 'Drama'], role: 'Indu', director: 'Vamsi Paidipally', poster: '', description: 'Released October 14, 2010.', trailer: '' },
    ...
    { id: 7, title: 'Dookudu', year: 2011, language: 'Telugu', genre: ['Action', 'Comedy'], role: 'Prashanthi', director: 'Srinu Vaitla', poster: '', description: 'Released September 23, 2011.', trailer: '' },
    { id: 8, title: 'Eega', year: 2012, language: 'Telugu', genre: ['Fantasy', 'Action'], role: 'Bindu', director: 'S. S. Rajamouli', poster: '', description: 'Released July 6, 2012.', trailer: '' },
    ...
    { id: 11, title: 'Yeto Vellipoyindhi Manasu', year: 2012, language: 'Telugu', genre: ['Romance', 'Drama'], role: 'Nithya', director: 'Gautham Vasudev Menon', poster: '', description: 'Released December 14, 2012.', trailer: '' },
    { id: 12, title: 'Seethamma Vakitlo Sirimalle Chettu', year: 2013, language: 'Telugu', genre: ['Drama'], role: 'Geetha', director: 'Srikanth Addala', poster: '', description: 'Released January 11, 2013.', trailer: '' },
    { id: 13, title: 'Jabardasth', year: 2013, language: 'Telugu', genre: ['Comedy'], role: 'Shreya', director: 'B. V. Nandini Reddy', poster: '', description: 'Released February 22, 2013.', trailer: '' },
    { id: 14, title: 'Attarintiki Daredi', year: 2013, language: 'Telugu', genre: ['Drama', 'Comedy'], role: 'Sashi', director: 'Trivikram Srinivas', poster: '', description: 'Released September 27, 2013.', trailer: '' },
    { id: 15, title: 'Ramayya Vasthavayya', year: 2013, language: 'Telugu', genre: ['Action', 'Drama'], role: 'Akkam', director: 'Harish Shankar', poster: '', description: 'Released October 11, 2013.', trailer: '' },
    { id: 16, title: 'Manam', year: 2014, language: 'Telugu', genre: ['Drama', 'Fantasy'], role: 'Anjali', director: 'Vikram Kumar', poster: '', description: 'Released May 23, 2014.', trailer: '' },
    { id: 17, title: 'Autonagar Surya', year: 2014, language: 'Telugu', genre: ['Action', 'Drama'], role: 'Siri', director: 'Deva Katta', poster: '', description: 'Released June 27, 2014.', trailer: '' },
    { id: 18, title: 'Alludu Seenu', year: 2014, language: 'Telugu', genre: ['Action', 'Comedy'], role: 'Cameo', director: 'V. V. Vinayak', poster: '', description: 'Cameo. Released July 24, 2014.', trailer: '' },
    { id: 19, title: 'Anjaan', year: 2014, language: 'Tamil', genre: ['Action', 'Thriller'], role: 'Jeeva', director: 'N. Lingusamy', poster: '', description: 'Released August 15, 2014.', trailer: '' },
    { id: 20, title: 'Rabhasa', year: 2014, language: 'Telugu', genre: ['Action', 'Comedy'], role: 'Indu', director: 'Santosh Srinivas', poster: '', description: 'Released August 29, 2014.', trailer: '' },
    { id: 21, title: 'Kaththi', year: 2014, language: 'Tamil', genre: ['Action', 'Drama'], role: 'Ankitha', director: 'A. R. Murugadoss', poster: '', description: 'Released October 22, 2014.', trailer: '' },
    { id: 22, title: 'S/O Satyamurthy', year: 2015, language: 'Telugu', genre: ['Drama'], role: 'Subbalakshmi', director: 'Trivikram Srinivas', poster: '', description: 'Released April 9, 2015.', trailer: '' },
    { id: 23, title: '10 Endrathukulla', year: 2015, language: 'Tamil', genre: ['Action'], role: 'Shakeela', director: 'Vijay Milton', poster: '', description: 'Released October 21, 2015.', trailer: '' },
    { id: 24, title: 'Thanga Magan', year: 2015, language: 'Tamil', genre: ['Drama'], role: 'Yamuna', director: 'Velraj', poster: '', description: 'Released December 18, 2015.', trailer: '' },
    { id: 25, title: 'Bangalore Naatkal', year: 2016, language: 'Tamil', genre: ['Drama'], role: 'Ammu', director: 'Bommarillu Bhaskar', poster: '', description: 'Released February 5, 2016.', trailer: '' },
    { id: 26, title: 'Theri', year: 2016, language: 'Tamil', genre: ['Action', 'Drama'], role: 'Annie', director: 'Atlee', poster: '', description: 'Released April 14, 2016.', trailer: '' },
    { id: 27, title: '24', year: 2016, language: 'Tamil', genre: ['Sci-Fi', 'Thriller'], role: 'Sathya', director: 'Vikram Kumar', poster: '', description: 'Released May 6, 2016.', trailer: '' },
    { id: 28, title: 'Brahmotsavam', year: 2016, language: 'Telugu', genre: ['Drama'], role: 'Kavya', director: 'Srikanth Addala', poster: '', description: 'Released May 20, 2016.', trailer: '' },
    { id: 29, title: 'A Aa', year: 2016, language: 'Telugu', genre: ['Romance', 'Drama'], role: 'Anasuya', director: 'Trivikram Srinivas', poster: '', description: 'Released June 2, 2016.', trailer: '' },
    { id: 30, title: 'Janatha Garage', year: 2016, language: 'Telugu', genre: ['Action', 'Drama'], role: 'Sita', director: 'Koratala Siva', poster: '', description: 'Released September 1, 2016.', trailer: '' },
    { id: 31, title: 'Raju Gari Gadhi 2', year: 2017, language: 'Telugu', genre: ['Horror', 'Thriller'], role: 'Amrutha', director: 'Ohmkar', poster: '', description: 'Released October 13, 2017.', trailer: '' },
    { id: 32, title: 'Mersal', year: 2017, language: 'Tamil', genre: ['Action', 'Thriller'], role: 'Anu Pallavi', director: 'Atlee', poster: '', description: 'Released October 18, 2017.', trailer: '' },
    { id: 33, title: 'Rangasthalam', year: 2018, language: 'Telugu', genre: ['Action', 'Drama'], role: 'Ramalakshmi', director: 'Sukumar', poster: '', description: 'Released March 30, 2018.', trailer: '' },
    { id: 34, title: 'Mahanati', year: 2018, language: 'Telugu', genre: ['Biography', 'Drama'], role: 'Madhuravani', director: 'Nag Ashwin', poster: '', description: 'Released May 9, 2018.', trailer: '' },
    ...
    { id: 36, title: 'Seemaraja', year: 2018, language: 'Tamil', genre: ['Action', 'Comedy'], role: 'Suthanthira Selvi', director: 'Ponram', poster: '', description: 'Released September 13, 2018.', trailer: '' },
    { id: 37, title: 'U Turn', year: 2018, language: 'Tamil', genre: ['Thriller'], role: 'Rachana', director: 'Pawan Kumar', poster: '', description: 'Released September 13, 2018.', trailer: '' },
    { id: 38, title: 'Super Deluxe', year: 2019, language: 'Tamil', genre: ['Drama', 'Thriller'], role: 'Vaembu', director: 'Thiagarajan Kumararaja', poster: '', description: 'Released March 29, 2019.', trailer: '' },
    { id: 39, title: 'Majili', year: 2019, language: 'Telugu', genre: ['Romance', 'Drama'], role: 'Sravani', director: 'Shiva Nirvana', poster: '', description: 'Released April 5, 2019.', trailer: '' },
    { id: 40, title: 'Oh! Baby', year: 2019, language: 'Telugu', genre: ['Fantasy', 'Comedy', 'Drama'], role: 'Savitri / Baby', director: 'B. V. Nandini Reddy', poster: '', description: 'Released July 5, 2019.', trailer: '' },
    ...
    { id: 42, title: 'Jaanu', year: 2020, language: 'Telugu', genre: ['Romance', 'Drama'], role: 'Jaanu', director: 'C. Prem Kumar', poster: '', description: 'Released February 7, 2020.', trailer: '' },
    { id: 43, title: 'Pushpa: The Rise', year: 2021, language: 'Telugu', genre: ['Action', 'Drama'], role: 'Special Appearance', director: 'Sukumar', poster: '', description: 'Special appearance. Released December 17, 2021.', trailer: '' },
    { id: 44, title: 'Kaathuvaakula Rendu Kaadhal', year: 2022, language: 'Tamil', genre: ['Romance', 'Comedy'], role: 'Khatija', director: 'Vignesh Shivan', poster: '', description: 'Released April 28, 2022.', trailer: '' },
    { id: 45, title: 'Yashoda', year: 2022, language: 'Telugu', genre: ['Action', 'Thriller'], role: 'Yashoda', director: 'Hari–Harish', poster: '', description: 'Released November 11, 2022.', trailer: '' },
    { id: 46, title: 'Shaakuntalam', year: 2023, language: 'Telugu', genre: ['Mythology', 'Drama', 'Romance'], role: 'Shakuntala', director: 'Gunasekhar', poster: 'https://res.cloudinary.com/dpnd6ve1e/image/upload/v1748018964/MV5BZmEyMTRmNzYtMWI2My00Y2ExLWI2ZGYtMDIwYTdkYmQ3NmY5XkEyXkFqcGc_._V1_FMjpg_UX1000__fz2hgv.jpg', description: 'Released April 14, 2023.', trailer: '' },
    { id: 47, title: 'Kushi', year: 2023, language: 'Telugu', genre: ['Romance', 'Comedy', 'Drama'], role: 'Aradhya', director: 'Shiva Nirvana', poster: 'https://res.cloudinary.com/dpnd6ve1e/image/upload/v1748018854/Vijay-Devarakonda--Samantha-s-Kushi-First-Look-1652675892-1297_dlc0dz.jpg', description: 'Released September 1, 2023.', trailer: '' },
    ...
    { id: 49, title: 'Maa Inti Bangaram', year: 2025, releaseDate: '2025-12-31', language: 'Telugu', genre: ['Drama'], role: 'TBA', director: 'TBA', poster: 'https://res.cloudinary.com/dpnd6ve1e/image/upload/v1748018602/202404283153600_c74nzb.webp', description: 'Expected 2025.', trailer: '' }
  ];
  ...
  webSeries: Movie[] = [
    {
      ...
      role: 'Raji',
      director: 'Raj & DK',
      poster: 'https://res.cloudinary.com/dpnd6ve1e/image/upload/v1748035514/familyman2_lpkdfu.jpg',
    ...
    },
    {
      ...
      role: 'TBA',
      director: 'Raj & DK',
      poster: 'https://res.cloudinary.com/dpnd6ve1e/image/upload/v1748035635/images_xiorwc.jpg',
    ...
    },
    {
      ...
      role: 'TBA',
      director: 'TBA',
      poster: 'https://res.cloudinary.com/dpnd6ve1e/image/upload/v1748035869/MV5BOTYwZGQ4ZWEtMWM1Yi00NTVkLWIwYjctMGI5OTk1YmM1ZGI4XkEyXkFqcGc_._V1__v3dg7i.jpg',
